import{bH as m,bF as y,bG as T,bx as M,bJ as Q,bK as R,bE as Se,bv as Ae,bw as I,bL as Ee,bM as _e,bN as Oe,bO as A}from"./index-DSrha9Sn.js";const Z="@firebase/installations",P="0.6.17";/**
 * @license
 ...
 */const ee=1e4,te=`w:${P}`,ne="FIS_v2",Ce="https://firebaseinstallations.googleapis.com/v1",Ne=60*60*1e3,De="installations",Me="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qe=/^[cdef][\w-]{21}$/,D="";function Le(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=xe(e);return qe.test(n)?n:D}catch{return D}}function xe(e){return $e(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he="installations",dt="installations-internal",ft=e=>{const t=e.getProvider("app").getImmediate(),n=ut(t),o=M(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:o,_delete:()=>Promise.resolve()}},pt=e=>{const t=e.getProvider("app").getImmediate(),n=M(t,he).getImmediate();return{getId:()=>at(n),getToken:i=>st(n,i)}};function lt(){y(new T(he,ft,"PUBLIC")),y(new T(dt,pt,"PRIVATE"))}lt();m(Z,P);m(Z,P,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St="firebase-messaging-database",At=1,h="firebase-messaging-store";let C=null;function $(){return C||(C=R(St,At,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(h)}}})),C}async function ye(e){const t=L(e),o=await(await $()).transaction(h).objectStore(h).get(t);if(o)return o;{const i=await It(e.appConfig.senderId);if(i)return await q(e,i),i}}async function q(e,t){const n=L(e),i=(await $()).transaction(h,"readwrite");return await i.objectStore(h).put(t,n),await i.done,t}async function Et(e){const t=L(e),o=(await $()).transaction(h,"readwrite");await o.objectStore(h).delete(t),await o.done}function L({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===b.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Y(n)):e.onMessageHandler.next(Y(n)));const o=n.data;qt(o)&&o[yt]==="1"&&await Wt(e,n.messageType,o)}const z="@firebase/messaging",X="0.12.21";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qt(e){if(!navigator)throw u.create("only-available-in-window");return e.swRegistration||await Ie(e),Mt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tn(e=Ae()){return Xt().then(t=>{if(!t)throw u.create("unsupported-browser")},t=>{throw u.create("indexed-db-unsupported")}),M(I(e),"messaging").getImmediate()}async function nn(e,t){return e=I(e),ve(e,t)}function on(e){return e=I(e),Qt(e)}function rn(e,t){return e=I(e),Zt(e,t)}zt();export{on as deleteToken,tn as getMessaging,nn as getToken,Xt as isSupported,rn as onMessage};
