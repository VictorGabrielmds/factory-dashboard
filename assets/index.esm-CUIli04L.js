import{bK as ge,bL as v,bM as me,bN as be,bO as Re,bP as Z,bQ as we,bR as Te,bS as ye,bT as ke,bU as Ee,bV as Ae,bW as W,bX as Ue}from"./index-Bwd2euOG.js";/**
 * @license
 ...
 */const J="firebasestorage.googleapis.com",Q="storageBucket",Oe=2*60*1e3,Ne=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class g{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=g.makeFromUrl(t,n)}catch{return new g(t,"")}if(s.path==="")return s;throw Be(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function o(_){_.path.charAt(_.path.length-1)==="/"&&(_.path_=_.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+r+i,"i"),u={bucket:1,path:3};function h(_){_.path_=decodeURIComponent(_.path)}const d="v[A-Za-z0-9_]+",b=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",R=new RegExp(`^https?://${b}/${d}/b/${r}/o${m}`,"i"),w={bucket:1,path:3},k=n===J?"(?:storage.googleapis.com|storage.cloud.google.com)":n,p="([^?#]*)",N=new RegExp(`^https?://${k}/${r}/${p}`,"i"),T=[{regex:a,indices:u,postModify:o},{regex:R,indices:w,postModify:h},{regex:N,indices:{bucket:1,path:2},postModify:h}];for(let _=0;_<T.length;_++){const C=T[_],L=C.regex.exec(t);if(L){const _e=L[C.indices.bucket];let S=L[C.indices.path];S||(S=""),s=new g(_e,S),C.postModify(s);break}}if(s==null)throw Se(t);return s}}class Ve{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qe(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let h=!1;function d(...p){h||(h=!0,t.apply(null,p))}function b(p){r=setTimeout(()=>{r=null,e(R,u())},p)}function m(){o&&clearTimeout(o)}function R(p,...N){if(h){m();return}if(p){m(),d.call(null,p,...N);return}if(u()||i){m(),d.call(null,p,...N);return}s<64&&(s*=2);let T;a===1?(a=2,T=0):T=(s+Math.random())*1e3,b(T)}let w=!1;function k(p){w||(w=!0,m(),!h&&(r!==null?(p||(a=2),clearTimeout(r),b(0)):p||(a=1)))}return b(0),o=setTimeout(()=>{i=!0,k(!0)},n),k}function We(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E{constructor(t,n){let s=0,r="";z(t)?(this.data_=t,s=t.size,r=t.type):t instanceof ArrayBuffer?(n?this.data_=new Uint8Array(t):(this.data_=new Uint8Array(t.byteLength),this.data_.set(new Uint8Array(t))),s=this.data_.length):t instanceof Uint8Array&&(n?this.data_=t:(this.data_=new Uint8Array(t.length),this.data_.set(t)),s=t.length),this.size_=s,this.type_=r}size(){return this.size_}type(){return this.type_}slice(t,n){if(z(this.data_)){const s=this.data_,r=st(s,t,n);return r===null?null:new E(r)}else{const s=new Uint8Array(this.data_.buffer,t,n-t);return new E(s,!0)}}static getBlob(...t){if(j()){const n=t.map(s=>s instanceof E?s.data_:s);return new E(nt.apply(null,n))}else{const n=t.map(i=>$(i)?ot(y.RAW,i).data:i.data_);let s=0;n.forEach(i=>{s+=i.byteLength});const r=new Uint8Array(s);let o=0;return n.forEach(i=>{for(let a=0;a<i.length;a++)r[o++]=i[a]}),new E(r,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function le(e){if(!e)throw H()}function bt(e,t){function n(s,r){const o=ue(e,r,t);return le(o!==null),o}return n}function Rt(e,t){function n(s,r){const o=ue(e,r,t);return le(o!==null),gt(o,r,e.host,e._protocol)}return n}function he(e){function t(n,s){let r;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?r=De():r=Ce():n.getStatus()===402?r=Pe(e.bucket):n.getStatus()===403?r=xe(e.path):r=s,r.status=n.getStatus(),r.serverResponse=s.serverResponse,r}return t}function wt(e){const t=he(e);function n(s,r){let o=t(s,r);return s.getStatus()===404&&(o=Ie(e.path)),o.serverResponse=r.serverResponse,o}return n}function Tt(e,t,n){const s=t.fullServerUrl(),r=V(s,e.host,e._protocol),o="GET",i=e.maxOperationRetryTime,a=new ce(r,o,Rt(e,n),i);return a.errorHandler=wt(t),a}function yt(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function kt(e,t,n){const s=Object.assign({},n);return s.fullPath=e.path,s.size=t.size(),s.contentType||(s.contentType=yt(null,t)),s}function Et(e,t,n,s,r){const o=t.bucketOnlyServerUrl(),i={"X-Goog-Upload-Protocol":"multipart"};function a(){let T="";for(let _=0;_<2;_++)T=T+Math.random().toString().slice(2);return T}const u=a();i["Content-Type"]="multipart/related; boundary="+u;const h=kt(t,s,r),d=mt(h,n),b="--"+u+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe="storage";function Ft(e,t,n){return e=v(e),Ot(e,t,n)}function Mt(e){return e=v(e),Nt(e)}function Ht(e,t){return e=v(e),Dt(e,t)}function $t(e=ge(),t){e=v(e);const s=me(e,pe).getImmediate({identifier:t}),r=be("storage");return r&&vt(s,...r),s}function vt(e,t,n,s={}){xt(e,t,n,s)}function Lt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,Ue)}function St(){Ee(new Ae(pe,Lt,"PUBLIC").setMultipleInstances(!0)),W(G,Y,""),W(G,Y,"esm2017")}St();export{l as StorageError,c as StorageErrorCode,y as StringFormat,E as _FbsBlob,g as _Location,ot as _dataFromString,M as _invalidArgument,je as _invalidRootOperation,vt as connectStorageEmulator,Mt as getDownloadURL,$t as getStorage,Ht as ref,Ft as uploadBytes};
